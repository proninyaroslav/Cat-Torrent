        ...
        DetailTorrentFragment.Callback
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        FiveStarsDialog fiveStarsDialog = new FiveStarsDialog(this, "contact.arsalanengr@gmail.com");
        fiveStarsDialog.setRateText("How was your experience with us?")
                .setTitle("Tell us what you like and dislike in this app by giving a review and suggestion")
                .setForceMode(true)
